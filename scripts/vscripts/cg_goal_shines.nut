...
function createBubbleShine(orig){
	
	local pos = null

	local traceTable = { start = orig + Vector(0,0,16), end = orig + Vector(0,0,-128), ignore = "", mask = TRACE_MASK_PLAYER_SOLID }
